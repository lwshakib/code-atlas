...
/**
 * RAW LOGO ICON
 * A custom triple-layered SVG representing the 'Atlas' stacking effect.
 */
...
/**
 * LOGO WITH TEXT
 * Composits the icon with the "Code Atlas" text, ensuring consistent sizing and alignment.
 */
