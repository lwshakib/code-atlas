...
export function UserMenu() {
  ...
  return (
    <DropdownMenu>
      ...
      {/* DROPDOWN CONTENT */}
      <DropdownMenuContent align="end" className="w-64 mt-2 p-1.5 border-border/50 backdrop-blur-xl bg-background/95 shadow-2xl">
        ...
        {/* Navigation Section */}
        <DropdownMenuItem onClick={() => router.push('/codebase')} className="cursor-pointer rounded-md focus:bg-secondary/80 py-2.5">
